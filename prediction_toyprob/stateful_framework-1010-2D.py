...
def main():
	...
	# TEST2
	x1 = 0.8*np.cos(t) + np.random.normal(-0.03, 0.03, np.shape(t) ) + 0.05
	x2 = 0.8*np.sin(t) + np.random.normal(-0.03, 0.03, np.shape(t) ) + 0.05
...
def define_network(batch_size, timesteps, input_dim, n_neurons, load_weight=False):
	...
	if load_weight:
		...
		model.load_weights('./models/stateful-2D.h5')
...
def fit_lstm(model):
	...
	model.save_weights('./models/stateful-2D.h5')
...
def generate_sincos():
	...
	for i in xrange(batch_size):
	    if i<n:
	        ...
	        x2 = 0.9*np.sin(5*t) #+ np.random.normal(-0.04, 0.04, np.shape(t) )
	    	x2 = x2[0:10]
	...
	ax01 = subplot2grid((8, 2), (0, 0))
	ax02 = subplot2grid((8, 2), (1, 0))
	ax03 = subplot2grid((8, 2), (2, 0))
	ax04 = subplot2grid((8, 2), (3, 0))
	ax05 = subplot2grid((8, 2), (4, 0))
	ax06 = subplot2grid((8, 2), (5, 0))
	ax07 = subplot2grid((8, 2), (6, 0))
	ax08 = subplot2grid((8, 2), (7, 0))
	ax09 = subplot2grid((8, 2), (0, 1))
	ax10 = subplot2grid((8, 2), (1, 1))
	ax11 = subplot2grid((8, 2), (2, 1))
	ax12 = subplot2grid((8, 2), (3, 1))
	ax13 = subplot2grid((8, 2), (4, 1))
	ax14 = subplot2grid((8, 2), (5, 1))
	ax15 = subplot2grid((8, 2), (6, 1))
	ax16 = subplot2grid((8, 2), (7, 1))
	ax01.grid(True)
	ax01.plot(t, X[0,:,1])
	ax02.grid(True)
	ax02.plot(t, X[16,:,1])
